/**
 * @id trganda/java/java-queries/unbounded-recursion
 * @name Recursive method calls
 * @description This query identifies methods that call themselves directly or indirectly, potentially leading to unbounded recursion.
 * @kind path-problem
 * @precision low
